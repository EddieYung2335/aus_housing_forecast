# take in date -> give back log_return for next quarter -> human_readable price
...
def predict_next_quarter(panel, model, metadata):
    ...
    result = pd.DataFrame(
        {
            ...
            "target_date": latest["date"] + pd.DateOffset(months=3),
...
if __name__ == "__main__":
    ...
    result = predict_next_quarter(panel, model, metadata)
